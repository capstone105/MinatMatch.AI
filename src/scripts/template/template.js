  ...
  return `
    <div class="flex flex-col gap-4 lg:flex-row lg:gap-14 items-center">
      ...
      <div id="auth-controls" class="flex flex-col gap-4 lg:flex-row items-center">
        <a id="logout-button" class="inline-block w-36 py-1 rounded-full text-white text-center shadow-[0_4px_20px_rgba(93,52,241,0.5)] bg-gradient-to-r from-[#686DE0] to-[#4834D4] hover:opacity-90 transition">Logout</a>
      </div>
    </div>
`;
}
